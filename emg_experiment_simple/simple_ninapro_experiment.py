...
def run_experiment(
    ...
    #TODO change to leave one out experiment
    ...
    for in_dir in tqdm(input_data_dir_list, desc="Data sets"):
        ...
        raw_set:RawSignals = pre_set["accepted"]
        ...
        for result_sublist in results_list:
            ...
            for (
                ...
                ] = np.array([y_test, y_pred]).reshape(-1)
    ...
    for result_file in result_files:
        ...
        with PdfPages(pdf_file_path) as pdf:
            ...
            for extractor_name in results_holder[Dims.EXTRACTORS.value].values:
                print("# {}\n".format(extractor_name), file=report_file_handler)
                for method_name in method_names:
                    print("## {}\n".format(method_name), file=report_file_handler)
                ...
                # 2 x folds
                    ...
                    y_gt = sub_results[0,:]
                    y_pred = sub_results[1,:]
                    report = classification_report(y_gt, y_pred, output_dict=True)
...
def main():
    ...
    output_directory = os.path.join(
        ...
        "./results_ninapro_simple_experiment/",
    )
    os.makedirs(output_directory, exist_ok=True)
